...
public interface ASMPhysicReg {
  ...
  public static ASMReg ra= new ASMReg("ra", 1,0);
  ...
  public static ASMReg[] calleeReg ={ra, s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11};
  public static ASMReg[] callerReg ={a0, a1, a2, a3, a4, a5, a6, a7, t3, t4};
