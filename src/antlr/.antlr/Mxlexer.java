...
public class Mxlexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CapitalLetter", "Number", "Interger", "Identifier", "ConstString", "F_PREFIX", 
			"QUOTE", "FormatChar", "ConstArray", "ConstElement", "Comment", "BlockComment", 
			"Whitespace", "Plus", "Minus", "Multiply", "Divide", "Mod", "Greater", 
			"Less", "GreaterEqual", "LessEqual", "Equal", "InEqual", "And", "Or", 
			"Not", "LeftMove", "RightMove", "AndBit", "OrBit", "XorBit", "NotBit", 
			"Assign", "AddAssign", "SubAssign", "MulAssign", "DivAssign", "ModAssign", 
			"LeftMoveAssign", "RightMoveAssign", "AndAssign", "OrAssign", "XorAssign", 
			"AssignType", "SelfPlus", "SelfMinus", "Member", "LeftBracket", "RightBracket", 
			"LeftSquareBracket", "RightSquareBracket", "LeftBrace", "RightBrace", 
			"Comma", "Semicolon", "Colon", "QestionMark", "DoubleLeftBrace", "DoubleRightBrace"
		};
	}
