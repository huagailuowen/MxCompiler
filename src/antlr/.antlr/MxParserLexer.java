...
public class MxparserLexer extends Lexer {
	...
	public static final int
		...
		ConstArray=23, ConstElement=24, Comment=25, BlockComment=26, Whitespace=27, 
		Plus=28, Minus=29, Multiply=30, Divide=31, Mod=32, Greater=33, Less=34, 
		GreaterEqual=35, LessEqual=36, Equal=37, InEqual=38, And=39, Or=40, Not=41, 
		LeftMove=42, RightMove=43, AndBit=44, OrBit=45, XorBit=46, NotBit=47, 
		Assign=48, AddAssign=49, SubAssign=50, MulAssign=51, DivAssign=52, ModAssign=53, 
		LeftMoveAssign=54, RightMoveAssign=55, AndAssign=56, OrAssign=57, XorAssign=58, 
		AssignType=59, SelfPlus=60, SelfMinus=61, Member=62, LeftBracket=63, RightBracket=64, 
		LeftSquareBracket=65, RightSquareBracket=66, LeftBrace=67, RightBrace=68, 
		Comma=69, Semicolon=70, Colon=71, QestionMark=72;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CapitalLetter", "Number", "Interger", "Identifier", "ConstString", "ConstArray", 
			"ConstElement", "Comment", "BlockComment", "Whitespace", "Plus", "Minus", 
			"Multiply", "Divide", "Mod", "Greater", "Less", "GreaterEqual", "LessEqual", 
			"Equal", "InEqual", "And", "Or", "Not", "LeftMove", "RightMove", "AndBit", 
			"OrBit", "XorBit", "NotBit", "Assign", "AddAssign", "SubAssign", "MulAssign", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ConstArray", "ConstElement", "Comment", "BlockComment", "Whitespace", 
			"Plus", "Minus", "Multiply", "Divide", "Mod", "Greater", "Less", "GreaterEqual", 
			"LessEqual", "Equal", "InEqual", "And", "Or", "Not", "LeftMove", "RightMove", 
			"AndBit", "OrBit", "XorBit", "NotBit", "Assign", "AddAssign", "SubAssign", 
			"MulAssign", "DivAssign", "ModAssign", "LeftMoveAssign", "RightMoveAssign", 
			"AndAssign", "OrAssign", "XorAssign", "AssignType", "SelfPlus", "SelfMinus", 
			"Member", "LeftBracket", "RightBracket", "LeftSquareBracket", "RightSquareBracket", 
			"LeftBrace", "RightBrace", "Comma", "Semicolon", "Colon", "QestionMark"
		};
	}
