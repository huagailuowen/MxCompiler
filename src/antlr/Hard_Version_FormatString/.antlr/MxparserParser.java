...
public class MxparserParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115188075879680L) != 0)) {
				{
				setState(57);
				_errHandler.sync(this);
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115188075863296L) != 0)) {
				{
				setState(70);
				_errHandler.sync(this);
	...
	public final FunctionDeclarationContext functionDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144115188075863296L) != 0)) {
				{
				setState(81);
	...
	public final ParameterListContext parameterList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2236266188353282562L) != 0)) {
				{
				setState(98);
				expression(0);
				}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2237392088292900610L) != 0)) {
				{
				{
				setState(142);
				statement();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case SelfMinus:
				...
				setState(265);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 228973363593216L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ConstArrayContext constArray() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 506654958079410688L) != 0)) {
				{
				setState(351);
				constElement();
				}
